			...
			<Card className="w-full max-w-[400px] bg-white dark:bg-gray-800 shadow-lg">
				...
				<CardContent className="space-y-4">
					...
					<Button
						...
						className="w-full flex items-center justify-center space-x-2 bg-gray-200 hover:bg-gray-300 text-gray-900 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100"
						variant="secondary"
					>
						<svg
