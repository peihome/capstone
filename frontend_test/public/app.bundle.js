...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _FileUploadLogic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FileUploadLogic */ "./jsx/FileUploadLogic.js");
...
function FileUploadForm() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0,_FileUploadLogic__WEBPACK_IMPORTED_MODULE_1__.uploadFileInChunks)(file, function (percentage) {
              return setProgress(percentage * 100);
            });
          case 4:
            _context.next = 7;
            break;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Upload a File"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("form", {
    ...
    type: "submit"
  }, "Upload")), progress > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "Progress: ", progress.toFixed(2), "%"));
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FileUploadForm);

/***/ }),

/***/ "./jsx/FileUploadLogic.js":
/*!********************************!*\
  !*** ./jsx/FileUploadLogic.js ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 3;
          _context.next = 6;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(initiateUrl, {
            fileName: file.name
          });
        case 6:
        ...
        case 11:
          ...
          console.error('Failed to initiate multipart upload:', _context.t0);
        ...
        case 15:
          ...
          for (chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++) {
            ...
            uploadPromise = uploadChunk(formData, onProgress, chunkIndex, totalChunks);
        ...
        case 19:
          ...
          _context.next = 26;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(completeUrl, {
            uploadId: uploadId,
            fileName: file.name,
            parts: parts
          });
...
function uploadChunk(_x3, _x4, _x5, _x6) {
  return _uploadChunk.apply(this, arguments);
}
function _uploadChunk() {
  _uploadChunk = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(formData, onProgress, chunkIndex, totalChunks) {
    var response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(uploadUrl, formData, {
            headers: {
              'Content-Type': 'multipart/form-data'
            },
            onUploadProgress: function onUploadProgress(progressEvent) {
              if (onProgress) {
                var progress = (chunkIndex + 1) / totalChunks * (progressEvent.loaded / progressEvent.total);
                onProgress(progress);
              }
            }
          });
...
function KafkaProducer() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    socket.onmessage = function (event) {
      setReceivedMessages(function (prev) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("".concat(backendUrl, "/send"), {
              message: message
            });
          case 3:
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "App"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Kafka Messaging with Docker"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
    type: "text",
    value: message,
    ...
    onClick: sendMessage
  }, "Send Message"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Received Kafka Messages:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", null, receivedMessages.map(function (msg, index) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
      key: index
    }, msg);
  })));
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (KafkaProducer);

/***/ }),

/***/ "./jsx/S3VideoPlayer.jsx":
/*!*******************************!*\
  !*** ./jsx/S3VideoPlayer.jsx ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var S3VideoPlayer = function S3VideoPlayer() {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
    _useState2 = _slicedToArray(_useState, 2),
